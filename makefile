...
install-qr-a:
	sudo cp /root/turnstile_controller/qr_script_a.service /etc/systemd/system/
...
install-qr-b:
	sudo cp /root/turnstile_controller/qr_script_b.service /etc/systemd/system/
	sudo systemctl daemon-reload
...
install-heartbeat:
	sudo cp /root/turnstile_controller/heartbeat-monitor.service /etc/systemd/system/
	sudo systemctl daemon-reload
...
install-cronjob:
	sudo cp /root/turnstile_controller/download_customer_db.service /etc/systemd/system/
	sudo cp /root/turnstile_controller/download_customer_db.timer /etc/systemd/system/
	sudo systemctl daemon-reload
...
install-upload:
	sudo cp /root/turnstile_controller/upload.service /etc/systemd/system/
	sudo systemctl daemon-reload
...
install-videorecorder:
	sudo cp /root/turnstile_controller/videorecorder.service /etc/systemd/system/
	sudo systemctl daemon-reload
...
install-mqtt-sender:
	sudo cp /root/turnstile_controller/mqtt-sender.service /etc/systemd/system/
	sudo systemctl daemon-reload
...
install-mqtt-receiver:
	sudo cp /root/turnstile_controller/mqtt-receiver.service /etc/systemd/system/
	sudo systemctl daemon-reload
